...
Config.Farm.Plots.Seed = {
    ...
    -- ----- 5 horticultural (vegetables / leaves / bulbs / tubers) -----
    {
    ...
    {
        plot_id = 'mlo_plot_horticultural_04',
        plot_type = 'horticultural',
        display_name_key = 'plots.plot.horticultural_04',
        coords_x = 2260.0,
        coords_y = 4765.4,
        coords_z = 38.82,
        radius = 5.0,
    ...
    {
        plot_id = 'mlo_plot_horticultural_05',
        plot_type = 'horticultural',
        display_name_key = 'plots.plot.horticultural_05',
        coords_x = 2265.0,
        coords_y = 4765.4,
        coords_z = 38.82,
        radius = 5.0,
